...
import { generateCerImageUrl } from '@/utils';
                  ...
                  <div className=' flex-1 flex flex-col gap-3'>
                    ...
                    <div className=' flex gap-3'>
                      <div className=' flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                        <img
                          src={generateCerImageUrl(car, '29')}
                          alt='car'
                          className='object-contain' />
                      </div>
                      <div className=' flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                        <img
                          src={generateCerImageUrl(car, '33')}
                          alt='car'
                          className='object-contain' />
                      </div>
                      <div className=' flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                        <img
                          src={generateCerImageUrl(car, '13')}
                          alt='car'
                          className='object-contain' />
                      </div>
                    </div>
